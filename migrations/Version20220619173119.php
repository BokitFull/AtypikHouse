 ...
 */
<<<<<<<< HEAD:migrations/Version20220619154450.php
final class Version20220619154450 extends AbstractMigration
========
final class Version20220619173119 extends AbstractMigration
>>>>>>>> 252d57f26e930dea22f8c781d0bde2ba8a2d2829:migrations/Version20220619173119.php
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commentaires (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT DEFAULT NULL, reservation_id INT DEFAULT NULL, commentaire_parent_id INT DEFAULT NULL, commentaire LONGTEXT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_D9BEC0C4FB88E14F (utilisateur_id), UNIQUE INDEX UNIQ_D9BEC0C4B83297E7 (reservation_id), UNIQUE INDEX UNIQ_D9BEC0C4FDED4547 (commentaire_parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
<<<<<<<< HEAD:migrations/Version20220619154450.php
        ...
        $this->addSql('CREATE TABLE habitats (id INT AUTO_INCREMENT NOT NULL, proprietaire_id INT DEFAULT NULL, libelle VARCHAR(150) NOT NULL, adresse VARCHAR(100) NOT NULL, code_postal VARCHAR(10) NOT NULL, ville VARCHAR(80) NOT NULL, pays VARCHAR(80) NOT NULL, est_disponible TINYINT(1) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', images LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', description_title VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, INDEX IDX_B5E492F376C50E4A (proprietaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE notes (id INT AUTO_INCREMENT NOT NULL, reservation_id INT DEFAULT NULL, utilisateur_id INT DEFAULT NULL, note VARCHAR(20) NOT NULL, note_proprete DOUBLE PRECISION NOT NULL, note_accueil DOUBLE PRECISION NOT NULL, note_emplacement DOUBLE PRECISION NOT NULL, note_qualite_prix DOUBLE PRECISION NOT NULL, note_equipements DOUBLE PRECISION NOT NULL, UNIQUE INDEX UNIQ_11BA68CB83297E7 (reservation_id), UNIQUE INDEX UNIQ_11BA68CFB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateurs (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, nom VARCHAR(80) NOT NULL, prenom VARCHAR(80) NOT NULL, civilite VARCHAR(2) DEFAULT NULL, telephone VARCHAR(20) DEFAULT NULL, adresse VARCHAR(100) DEFAULT NULL, code_postal VARCHAR(10) DEFAULT NULL, ville VARCHAR(80) DEFAULT NULL, pays VARCHAR(80) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', image VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_497B315EE7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
========
        $this->addSql('CREATE TABLE equipements (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(100) NOT NULL, description LONGTEXT NOT NULL, etat VARCHAR(50) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE habitats (id INT AUTO_INCREMENT NOT NULL, proprietaire_id INT DEFAULT NULL, libelle VARCHAR(150) NOT NULL, adresse VARCHAR(100) NOT NULL, code_postal VARCHAR(10) NOT NULL, ville VARCHAR(80) NOT NULL, pays VARCHAR(80) NOT NULL, est_disponible TINYINT(1) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', images JSON DEFAULT NULL, description_title VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, INDEX IDX_B5E492F376C50E4A (proprietaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE habitats_equipements (habitats_id INT NOT NULL, equipements_id INT NOT NULL, INDEX IDX_EF2D363D35D3C6F5 (habitats_id), INDEX IDX_EF2D363D852CCFF5 (equipements_id), PRIMARY KEY(habitats_id, equipements_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE notes (id INT AUTO_INCREMENT NOT NULL, reservation_id INT DEFAULT NULL, utilisateur_id INT DEFAULT NULL, note_proprete DOUBLE PRECISION NOT NULL, note_accueil DOUBLE PRECISION NOT NULL, note_emplacement DOUBLE PRECISION NOT NULL, note_qualite_prix DOUBLE PRECISION NOT NULL, note_equipements DOUBLE PRECISION NOT NULL, UNIQUE INDEX UNIQ_11BA68CB83297E7 (reservation_id), UNIQUE INDEX UNIQ_11BA68CFB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE promotions (id INT AUTO_INCREMENT NOT NULL, reservation_id INT DEFAULT NULL, montant DOUBLE PRECISION NOT NULL, date_debut DATETIME NOT NULL, date_fin DATETIME NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_EA1B3034B83297E7 (reservation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reservations (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT DEFAULT NULL, habitat_id INT DEFAULT NULL, montant DOUBLE PRECISION NOT NULL, date_debut DATETIME NOT NULL, date_fin DATETIME NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_4DA239FB88E14F (utilisateur_id), INDEX IDX_4DA239AFFE2D26 (habitat_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
...
>>>>>>>> 252d57f26e930dea22f8c781d0bde2ba8a2d2829:migrations/Version20220619173119.php
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE habitats_equipements DROP FOREIGN KEY FK_EF2D363D852CCFF5');
...
========
>>>>>>>> 252d57f26e930dea22f8c781d0bde2ba8a2d2829:migrations/Version20220619173119.php
        $this->addSql('ALTER TABLE habitats_equipements DROP FOREIGN KEY FK_EF2D363D35D3C6F5');
