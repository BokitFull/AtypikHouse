 ...
 */
final class Version20220522212933 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE habitats (id INT AUTO_INCREMENT NOT NULL, proprietaire_id INT DEFAULT NULL, libelle VARCHAR(150) NOT NULL, adresse VARCHAR(100) NOT NULL, code_postal VARCHAR(5) NOT NULL, ville VARCHAR(80) NOT NULL, pays VARCHAR(80) NOT NULL, est_disponible TINYINT(1) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_B5E492F376C50E4A (proprietaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateurs (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(80) NOT NULL, prenom VARCHAR(80) NOT NULL, civilite VARCHAR(2) NOT NULL, email VARCHAR(100) NOT NULL, password VARCHAR(100) NOT NULL, telephone VARCHAR(20) DEFAULT NULL, adresse VARCHAR(100) NOT NULL, code_postal VARCHAR(5) NOT NULL, ville VARCHAR(80) NOT NULL, pays VARCHAR(80) NOT NULL, role VARCHAR(30) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
