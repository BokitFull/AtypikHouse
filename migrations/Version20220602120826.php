 ...
 */
final class Version20220602120826 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateurs ADD role VARCHAR(30) NOT NULL, DROP roles, CHANGE civilite civilite VARCHAR(2) NOT NULL, CHANGE email email VARCHAR(100) NOT NULL, CHANGE password password VARCHAR(100) NOT NULL, CHANGE adresse adresse VARCHAR(100) NOT NULL, CHANGE code_postal code_postal VARCHAR(5) NOT NULL, CHANGE ville ville VARCHAR(80) NOT NULL, CHANGE pays pays VARCHAR(80) NOT NULL');
    }
