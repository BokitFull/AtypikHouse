 ...
 */
final class Version20220602125053 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateurs ADD roles JSON NOT NULL, DROP role, CHANGE civilite civilite VARCHAR(2) DEFAULT NULL, CHANGE email email VARCHAR(180) NOT NULL, CHANGE password password VARCHAR(255) NOT NULL, CHANGE adresse adresse VARCHAR(100) DEFAULT NULL, CHANGE code_postal code_postal VARCHAR(10) DEFAULT NULL, CHANGE ville ville VARCHAR(80) DEFAULT NULL, CHANGE pays pays VARCHAR(80) DEFAULT NULL');
