 ...
 */
final class Version20220705120032 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commentaires (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT DEFAULT NULL, reservation_id INT DEFAULT NULL, commentaire_parent_id INT DEFAULT NULL, commentaire LONGTEXT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_D9BEC0C4FB88E14F (utilisateur_id), INDEX IDX_D9BEC0C4B83297E7 (reservation_id), INDEX IDX_D9BEC0C4FDED4547 (commentaire_parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE equipements (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(100) NOT NULL, description LONGTEXT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE habitats (id INT AUTO_INCREMENT NOT NULL, proprietaire_id INT DEFAULT NULL, type_habitat_id INT DEFAULT NULL, libelle VARCHAR(150) NOT NULL, adresse VARCHAR(100) NOT NULL, code_postal VARCHAR(10) NOT NULL, ville VARCHAR(80) NOT NULL, pays VARCHAR(80) NOT NULL, est_disponible TINYINT(1) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', images LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', description_title VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, informations_supplementaires LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', prix DOUBLE PRECISION NOT NULL, nombre_personnes_max INT NOT NULL, statut TINYINT(1) NOT NULL, INDEX IDX_B5E492F376C50E4A (proprietaire_id), INDEX IDX_B5E492F3B2FDFB03 (type_habitat_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE notes (id INT AUTO_INCREMENT NOT NULL, reservation_id INT DEFAULT NULL, note VARCHAR(20) NOT NULL, note_proprete DOUBLE PRECISION NOT NULL, note_accueil DOUBLE PRECISION NOT NULL, note_emplacement DOUBLE PRECISION NOT NULL, note_qualite_prix DOUBLE PRECISION NOT NULL, note_equipements DOUBLE PRECISION NOT NULL, UNIQUE INDEX UNIQ_11BA68CB83297E7 (reservation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reservations (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT DEFAULT NULL, habitat_id INT DEFAULT NULL, montant DOUBLE PRECISION NOT NULL, date_debut DATETIME NOT NULL, date_fin DATETIME NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', statut TINYINT(1) NOT NULL, INDEX IDX_4DA239FB88E14F (utilisateur_id), INDEX IDX_4DA239AFFE2D26 (habitat_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
